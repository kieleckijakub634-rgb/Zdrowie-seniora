...
window.applyQuizCTAs = function() {
  if (localStorage.getItem('kz_quiz_completed') === '1') {
    ...
    if (!document.getElementById('fomo-banner')) {
      ...
      banner.style.cssText = 'position:fixed; top:70px; left:0; right:0; background:linear-gradient(90deg, #E05252, #B73232); color:white; text-align:center; padding:0.6rem; font-weight:700; font-size:0.9rem; z-index:15000; box-shadow:0 4px 12px rgba(224,82,82,0.3);';
